...
$url  = rawurlencode($pdf);
$size = round(filesize($ruta) / 1024, 2);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        /* Barra inferior de navegación de páginas */
        #paginador {
            background: #1e1e1e;
            color: #fff;
            padding: 10px 14px;
...
<body>
    ...
    <header>
        ...
        <div class="acciones">
            <!-- Único botón que permite descargar, y solo al pulsarlo -->
            <a href="<?= $url ?>" download>⬇️ Descargar</a>
        </div>
    </header>
...
/**
 * Calcula el ancho de render según el ancho de pantalla y el DPR
